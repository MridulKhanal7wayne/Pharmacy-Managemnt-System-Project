...
class PharmacyManagementSystem:
    def __init__(self,root):
        ...
        # ========== Title label======================================================================================
        lbltitle=Label(self.root,text="PHARMACY MANAGEMENT SYSTEM",bg="white",fg="pink",bd=15,relief=RIDGE,font=("times new roman",50,"bold"),padx=2,pady=6)
        lbltitle.pack(side=TOP,fill=X)


        img3 = Image.open("logos.jpg")
        img3 = img3.resize((80,80), Image.Resampling.LANCZOS)
        self.photoImg3 =  ImageTk.PhotoImage(img3)
        b3 =Button(self.root,image=self.photoImg3,text="Sharma Pharmacy",borderwidth=0,font=("times new roman",22,"bold"),fg="white",cursor="hand2")
        b3.place(x=70,y=20)
        ...
        DataFrameLeft=LabelFrame(DataFrame,bd=10,padx=20,relief=RIDGE,fg="pink",
                                                font=("arial",12,"bold"),text="Medicine Information")
        DataFrameLeft.place(x=0,y=5,width=900,height=350)

        lblReg=Label(DataFrameLeft,width=37,font=("arial",15,"bold"),text="The cure you want.The cure you need.",fg="red",padx=2,bg="white")
       ...
       # b4 =Button(self.root,image=self.photoImg1,text="Sharma Pharmacy",borderwidth=0,font=("times new roman",22,"bold"),fg="white",cursor="hand2")
       # b4.place(x=770,y=330)

        img2 = Image.open("photo.jfif")
        img2 = img2.resize((400,135), Image.Resampling.LANCZOS)
        self.photoImg2 =  ImageTk.PhotoImage(img2)
        b4 =Button(self.root,image=self.photoImg2,text="Sharma Pharmacy",borderwidth=0,font=("times new roman",22,"bold"),fg="white",cursor="hand2")
        b4.place(x=500,y=330)

      #  img4 = Image.open("tab.jpg")
      #  img4 = img4.resize((150,135), Image.Resampling.LANCZOS)
       # self.photoImg4 =  ImageTk.PhotoImage(img4)
       # b5 =Button(self.root,image=self.photoImg4,text="Sharma Pharmacy",borderwidth=0,font=("times new roman",22,"bold"),fg="white",cursor="hand2")
       # b5.place(x=475,y=330)
        ...
        # ========MainButtons=======
        btnAddData=Button(ButtonFrame,command=self.add_data,text="ADD MEDICINE",font=("arial",13,"bold"),width=14,bg="lavender",fg="black")
        btnAddData.grid(row=0,column=0)

        btnUpdateMed=Button(ButtonFrame,command=self.update_data,text="UPDATE",font=("arial",13,"bold"),width=14,bg="lavender",fg="black")
        btnUpdateMed.grid(row=0,column=1)

        btnDeleteMed=Button(ButtonFrame,command=self.mDelete,text="DELETE",font=("arial",13,"bold"),width=14,bg="lavender",fg="black")
        btnDeleteMed.grid(row=0,column=2)

        btnRestMed=Button(ButtonFrame,command=self.Reset,text="RESET",font=("arial",13,"bold"),width=14,bg="lavender",fg="black")
        btnRestMed.grid(row=0,column=3)

        btnExitMed=Button(ButtonFrame,command=self.iExit,text="EXIT",font=("arial",13,"bold"),width=14,bg="lavender",fg="black")
        btnExitMed.grid(row=0,column=4)

        # ==========Search By========
        lblSearch=Label(ButtonFrame,font=("arial",17,"bold"),text="Search By",padx=2,bg="lavender",fg="black")
        ...
        btnExit=Button(ButtonFrame,command=self.search_data,text="SEARCH",font=("arial",12,"bold"),width=14,bg="lavender",fg="black")
        btnExit.grid(row=0,column=8)

        btnExit=Button(ButtonFrame,command=self.fatch_data,text="SHOW ALL",font=("arial",12,"bold"),width=13,bg="lavender",fg="black")
        ...
        conn=mysql.connector.connect(host="localhost",username="root",password="1234",database="mydata2")
...
# ===============================Right Department Management labelframe =============================================================
        ...
        DataFrameRight=LabelFrame(DataFrame,bd=12,padx=20,relief=RIDGE,fg="pink",
       ...
       # b6.place(x=1160,y=160)
        ...
        entry_Medicine.place(x=135,y=100)
        ...
        down_frame=Frame(DataFrameRight,bd=4,relief=RIDGE,bg="lavender")
        down_frame.place(x=330,y=150,width=135,height=160)

        add_btn=Button(down_frame,text="ADD",command=self.add_medicine,font=("arial",12,"bold"),width=12,fg="black",bg="lavender") 
        add_btn.grid(row=0,column=0,pady=2)

        update_btn=Button(down_frame,command=self.med_update,text="UPDATE",font=("arial",12,"bold"),width=12,fg="black",bg="lavender")
        update_btn.grid(row=1,column=0,pady=2)

        delete_btn=Button(down_frame,command=self.medDelete,text="DELETE",font=("arial",12,"bold"),width=12,fg="black",bg="lavender")
        delete_btn.grid(row=2,column=0,pady=2)

        clear_btn=Button(down_frame,command=self.clear_med,text="CLEAR",font=("arial",12,"bold"),width=12,fg="black",bg="lavender")
